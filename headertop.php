			...
			<div id="sticker">
				...
				<div class="menu ">
					...
					<ul>
						...
						<li><a href="mycourses.php"><i class="fa fa-sign-out" aria-hidden="true"></i>My Courses</a></li>
						<li><a href="enroll.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Enroll</a></li>
						...
						<?php if($user->get_faculty_session()){ ?>
								...
								?></a></li>
								<li><a href="fc_courses.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Courses</a></li>
								<li><a href="fc_schedules.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Schedules</a></li>
					</ul>
							<?php } ?>
